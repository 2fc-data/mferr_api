...
const user_profile_model_1 = require("../database/models/user_profile.model");
const profile_rule_model_1 = require("../database/models/profile_rule.model");
let ProfilesModule = class ProfilesModule {
};
exports.ProfilesModule = ProfilesModule;
exports.ProfilesModule = ProfilesModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([profile_model_1.Profile, user_profile_model_1.UserProfile, profile_rule_model_1.ProfileRule])],
