/**
 * Helper functions for statistical calculations in dashboards.
 */
...
export function calculateBoxplotData(arr: number[]) {
  if (!arr || arr.length === 0)
...
export function generateHistogram(values: number[]) {
